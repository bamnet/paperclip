...
In your model:
  ...
  class User < ActiveRecord::Base
    ...
    default_scope select_without_file_columns_for(:avatar) #If you're using the database storage engine 
  end

Run:
  ./script/generate migration DBPaperclip User avatar

If you want to do it manually, migrate the following:
...
In your controller:
  ...
  downloads_files_for :user, :avatar #Tosses in a simple download action
...
This version of paperclip is based off Pat Shaughnessy's work found at:
http://patshaughnessy.net/paperclip-database-storage.  This provides database
storage,and most of the documentation has been updated to reflect that.  If 
you're not using the database storage engine, you probably don't want to use this.
